...
def plot_histograms(genuine_scores, impostor_scores):
    ...
    plt.grid(alpha=0.3)
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / "livdet_sourceafis_histogram.png", dpi=300, bbox_inches="tight")
    plt.close()
...
def plot_smoothed_pdfs(genuine_scores, impostor_scores, step=0.1, sigma_points=3.0):
    ...
    plt.grid(alpha=0.3)
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / "livdet_sourceafis_smoothed_pdf.png", dpi=300, bbox_inches="tight")
    plt.close()
...
def plot_far_frr(thresholds, fars, frrs, eer, eer_threshold):
    ...
    plt.grid(alpha=0.3)
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / "livdet_sourceafis_far_frr.png", dpi=300, bbox_inches="tight")
    plt.close()
...
def plot_p_success(thresholds, p_success, eer_threshold, max_success, max_threshold):
    ...
    plt.grid(alpha=0.3)
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / "livdet_sourceafis_p_success.png", dpi=300, bbox_inches="tight")
    plt.close()
...
def plot_success_and_or(
    ...
    plt.grid(alpha=0.3)
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / "livdet_sourceafis_success_and_or.png", dpi=300, bbox_inches="tight")
    plt.close()
