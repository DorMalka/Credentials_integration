...
Previous work on continuous credentials has primarily focused on improving scoring algorithms to increase evaluation accuracy.
...
\textit{Fingerprint Verification Competition 2002}.

\bibitem{fvc2004}
FVC2004 Web Site:http://bias.csr.unibo.it/fvc2004/.
\textit{Fingerprint Verification Competition 2004}.

\bibitem{Perez2012}
M. A. Medina-Pérez, M. García-Borroto, A. E. Gutierrez-Rodríguez, and
L. Altamirano-Robles.\\
\textit{Improving fingerprint verification using minutiae triplets}.\\
Sensors, vol. 12, no. 3, pp. 3418–3437, 2012.

\bibitem{Anil1997}
Anil K. Jain, Lin Hong, Ruud Bolle.\\
\textit{On-Line Fingerprint Verification}.\\
IEEE Transactions on Pattern Analysis and Machine Intelligence, Volume: 19, Issue: 4, April 1997.

\bibitem{Cappelli2006}
Raffaele Cappelli, Dario Maio, Davide Maltoni, James L. Wayman and Anil K. Jain.\\
\textit{Performance Evaluation of Fingerprint Verification Systems}.\\
IEEE Transactions on Pattern Analysis and Machine Intelligence, Volume: 28, Issue: 1, January 2006.

\bibitem{Maio2002}
Dario Maio, Davide Maltoni, Raffaele Cappelli, James L. Wayman and Anil K. Jain.\\
\textit{FVC2000: Fingerprint Verification Competition}.\\
IEEE Transactions on Pattern Analysis and Machine Intelligence, Volume: 24, Issue: 3, March 2002.
