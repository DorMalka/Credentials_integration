...
\begin{proposition}\label{thm:suf_nec_cond_for_improve}
    Let~$M$ be a mechanism comprising an atomic credential with~$P^1_\text{safe} > 0$ and at least one of~$P^1_\text{leak},P^1_\text{loss} > 0$. Then, there exists~$\bar{M}$ obtained by adding to~$M$ a biometric credential whose user and attacker distributions are asymptotically separable, such that
    \begin{equation*}
        P_{\mathrm{success}}^{\bar{M}} > P_{\mathrm{success}}^{M}
    \end{equation*}
\end{proposition}
...
Let~$M$ be a mechanism comprising an atomic credential with~$P_\text{safe}>0$ and at least one of~$P_\text{leak},P_\text{loss} > 0$. Then, there exists~$\bar{M}$ obtained by adding to~$M$ a biometric credential whose user and attacker distributions are asymptotically dominated, such that 
\begin{equation*}
